...
COMMAND=
# Container name
CONTAINER_NAME=psql_context_data
# Container host name
CONTAINER_HOST_NAME=psql_context_data
# Work dir
WORKDIR=$(pwd)
# The version of Docker PG image to use
POSTGIS_DOCKER_TAG=gargantuan_giraffe
# The host
HOST=$MLKC_CONTEXT_DATA_HOST
# The port
PORT=$MLKC_CONTEXT_DATA_PG_EXTERNAL_PORT
# The user
USER=$MLKC_CONTEXT_DATA_POSTGIS_USER
# The pass
PASS=$MLKC_CONTEXT_DATA_POSTGIS_PASSWORD
# The DB
DB=postgres
